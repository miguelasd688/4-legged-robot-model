...
#        print(self.phi)
        ...
        step_coord = self.stepTrajectory(self.phi + offset[0] , V , angle , Wrot , 
                                         np.squeeze(np.asarray(bodytoFeet_[0,:])),duty_cycle*np.exp(step_asym)) #FR
        ...
        step_coord = self.stepTrajectory(self.phi + offset[1] , V , angle , Wrot ,
                                         np.squeeze(np.asarray(bodytoFeet_[1,:])),duty_cycle*np.exp(step_asym))#FL
        ...
        step_coord = self.stepTrajectory(self.phi + offset[2] , V , angle , Wrot , 
                                         np.squeeze(np.asarray(bodytoFeet_[2,:])),duty_cycle*np.exp(step_asym))#BR
        ...
        step_coord = self.stepTrajectory(self.phi + offset[3] , V , angle , Wrot , 
                                         np.squeeze(np.asarray(bodytoFeet_[3,:])),duty_cycle*np.exp(step_asym))#BL
